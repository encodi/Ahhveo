Function customize_section(s) as void
...
this={
     ...
     canvas:s.app.canvas
     menu:s.app.menu
     remoteCallBack:customize_handle_remote
     preferences:settings_preferences
     goBack:customize_go_main
     handleAction:customize_handle_action
     }


customize_menu=[]

customize_menu.Push({action:customize_handle_action,label:"Preferences",params:{subaction:settings_preferences}})
customize_menu.Push({action:customize_handle_action,label:"Sleep",params:{subaction:settings_sleep}})
customize_menu.Push({action:information_handle_action,label:"Helpful Hints",params:{subaction:settings_viewing_hints}})
customize_menu.Push({action:information_handle_action,label:"Artist",params:{subaction:settings_artist}})
customize_menu.Push({action:information_handle_action,label:"FAQ",params:{subaction:settings_faqs}})
customize_menu.Push({action:information_handle_action,label:"Buy Additional Time",params:{subaction:settings_preferences}})
customize_menu.Push({action:information_handle_action,label:"About",params:{subaction:settings_about}})
customize_menu.Push({action:information_handle_action,label:"Policy & Terms",params:{subaction:settings_terms}})
'customize_menu.Push({action:customize_handle_action,label:"New Playlist",params:{subaction:playlists_section}})
'customize_menu.Push({action:customize_handle_action,label:"Expand Collection",params:{subaction:shop_section}})

s.app.menu.setOptions(customize_menu)
s.app.menu.render(1)
...
if this.app.tos=false and this.app.trial and s.app.seeterms=false and s.app.seepolicy=false
    ...
    s.params={subaction:settings_preferences}
...
function customize_handle_remote(index) as void
...
function customize_handle_action(s) as void
   ...
   'And associates it children remote listener
    ...
    this={
          app:s.app
          goBack:customize_go_back
          goMain:customize_go_main
          remoteCallBack:customize_handle_remote
...
function customize_go_back() as void
...
function customize_go_main() as void
