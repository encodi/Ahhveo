function settings_viewing_hints(s) as object

    this={
          section:s
          remoteCallBack:settings_viewing_hints_remote_callback
          init:settings_viewing_hints_init
          canvas:s.canvas
          app:s.app
          remaining:60
          position:0
          selected:0
          enabled:false
          onReturn:settings_viewing_hints_on_return
          scrollVertical:settings_viewing_hints_scroll
          goBack:settings_viewing_hints_go_back
         }
...
function settings_viewing_hints_init(parent=false) as void
    ...
    items.push({text:" Ahhveo Viewing Hints",textAttrs:{font:m.app.h2},targetRect:header1_rect})
    ...
    tos=m.app.http.getWs("getHints.php")
...
function settings_viewing_hints_remote_callback(index) as void
...
function settings_viewing_hints_scroll() as void
    ...
    if IsHD()
        privacy.push({text:"vRoku Dec 2014",textAttrs:{VAlign:"top",HAlign:"Left",font:m.app.h3},targetRect:{w:m.w_,x:m.x_+600,y:m.scroll+600,h:m.height}})
    else
        privacy.push({text:"vRoku Dec 2014",textAttrs:{VAlign:"top",HAlign:"Left",font:m.app.h3},targetRect:{w:m.w_,x:m.x_+337,y:m.scroll+400,h:m.height}})
    endif
    if IsHD()
...
function settings_viewing_hints_on_return(index) as boolean
    return true
end function


function settings_viewing_hints_go_back() as void
