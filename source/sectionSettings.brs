Function settings_section(s) as void
...
this={
     ...
     canvas:s.app.canvas
     menu:s.app.menu
     remoteCallBack:settings_handle_remote
     preferences:settings_preferences
     goBack:settings_go_main
     handleAction:settings_handle_action
     }
...
settings_menu.Push({action:settings_handle_action,label:"Preferences",params:{subaction:settings_preferences}})
settings_menu.Push({action:settings_handle_action,label:"Helpful Hints",params:{subaction:settings_viewing_hints}})
settings_menu.Push({action:settings_handle_action,label:"Sleep",params:{subaction:settings_sleep}})
settings_menu.Push({action:settings_handle_action,label:"FAQ",params:{subaction:settings_faqs}})
settings_menu.Push({action:settings_handle_action,label:"About",params:{subaction:settings_about}})
settings_menu.Push({action:settings_handle_action,label:"Artist",params:{subaction:settings_artist}})
settings_menu.Push({action:settings_handle_action,label:"Privacy Policy",params:{subaction:settings_privacy}})
settings_menu.Push({action:settings_handle_action,label:"Terms of Use",params:{subaction:settings_terms}})
...
function settings_handle_remote(index) as void
...
function settings_handle_action(s) as void
   ...
   'And associates it children remote listener
    ...
    this={
          app:s.app
          goBack:settings_go_back
          goMain:settings_go_main
          remoteCallBack:settings_handle_remote
...
function settings_go_back() as void
...
function settings_go_main() as void
