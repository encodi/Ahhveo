...
Function CreateApp() As Object
   ...
   ' Register available fonts:
    ...
    this.fonts.Register("pkg:/fonts/Proxima-Nova-Alt-Lt.otf")
    
    if (IsHD())
        this.menufont=this.fonts.get("HelveticaNeueLT Std Med",26,false,false)
        this.carouseltitlefont=this.fonts.get("Proxima Nova Alt Lt",32,false,false)
        this.carouseldescriptionfont=this.fonts.get("Proxima Nova Alt Lt",25,false,false)
        this.tooltipfont=this.fonts.get("Proxima Nova Alt Lt",15,false,false)
        this.h1=this.fonts.get("Proxima Nova Alt Lt",35,false,false)
        this.h2=this.fonts.get("Proxima Nova Alt Lt",30,false,false)
        this.h35=this.fonts.get("Proxima Nova Alt Lt",22,false,false)
        this.h3=this.fonts.get("Proxima Nova Alt Lt",25,false,false)
        this.h4=this.fonts.get("Proxima Nova Alt Lt",20,false,false)
        this.h45=this.fonts.get("Proxima Nova Alt Lt",18,false,false)
        this.h5=this.fonts.get("Proxima Nova Alt Lt",16,false,false)
        ...
        this.hnova=this.fonts.get("Proxima Nova Alt Lt",25,false,false)
    else
        this.menufont=this.fonts.get("HelveticaNeueLT Std Med",15,false,false)
        this.carouseltitlefont=this.fonts.get("Proxima Nova Alt Lt",18,false,false)
        this.carouseldescriptionfont=this.fonts.get("Proxima Nova Alt Lt",14,false,false)
